...
class NoiseClassifierXGBoost:
    ...
    def load_and_prepare_data(self, test_size=0.2, random_state=42):
        ...
        print(f"\n📊 Using {len(self.feature_names)} features for training:")
    ...
    def evaluate(self, X_test, y_test):
        ...
        print(f"\n✓ Confusion matrix saved to {self.model_save_dir}/confusion_matrix.png")
        plt.close()
    ...
    def save_model(self):
        ...
        print(f"\n💾 Saving model to {self.model_save_dir}...")
    ...
    def predict_from_image(self, image_path):
        ...
        print(f"\n🔍 Predicting noise type for: {image_path}")
        ...
        print(f"\n✓ Predicted noise type: {pred_label}")
        print(f"\nProbabilities:")
